...
import { Flex, LogoutIcon, useModal, UserMenu as UIKitUserMenu, UserMenuDivider, UserMenuItem } from 'gol-uikit'
...
const UserMenu = () => {
  ...
  return (
    <UIKitUserMenu account={account} avatarSrc={avatarSrc}>
      ...
      <UserMenuItem as="button" onClick={() => history.push(`/myNfts`)}>
        {t('Your NFTs')}
      </UserMenuItem>
      <UserMenuDivider />
