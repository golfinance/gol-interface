...
const MatchCandidate = ({ data, closeRequest, index }) => {
  ...
  const nftSelected = () => {
    const tmpSelectedMatchNfts = selectedMatchNfts
    tmpSelectedMatchNfts[index] = data.tokenId
    initSelectedMatchNfts(tmpSelectedMatchNfts)
