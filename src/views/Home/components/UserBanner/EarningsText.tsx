...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and GOL pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and GOL pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from GOL pool', data)
  }
